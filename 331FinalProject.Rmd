...
pollutants <- subset(pollutants , select = -X )
head(pollutants)
```
...
single <- paste(tail(colnames(pollutants),-1), collapse = " + ")
...
Mfull <- lm(f_interaction, data = pollutants)
Mstart <- lm(f_interaction, data = pollutants)
